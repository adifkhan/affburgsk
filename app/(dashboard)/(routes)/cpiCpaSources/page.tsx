...
export default function CPASources() {
        ...
        <Box
            ...
            <Box component={'div'}>
                <Typography variant='h5'
                    sx={{
                        color: '#ED7D31',
                        fontSize: '1.5rem'
                    }}>CPI/CPA Traffic Sources</Typography>
            </Box>
            <Card sx={{ backgroundColor: '#1C2437', color: 'whitesmoke', mt: 2 }}>
                <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 2, }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, width: '100%' }}>
                        <Typography variant='h5' sx={{ fontSize: 14 }}>CPI/CPA Campaign</Typography>
            ...
            <Card sx={{
                ...
                <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, }}>
                    <em style={{ fontWeight: 600, display: 'flex', alignItems: 'center', gap: 1 }}>Choose CPI/CPA campaign and date range to view results.</em>
                </CardContent>
            </Card>
        </Box >
    )
